...
const appCss = "/assets/styles-CFR37XNO.css";
...
const en = {
  ...
  hero: {
    ...
    description: "I design and ship polished frontends, Node.js APIs, and production systems for SaaS founders and growing businesses that need one senior builder from first brief to launch.",
    ...
    currentSignalBody: "Enterprise consulting experience with Airbus and Bosch, paired with end-to-end product work for SaaS founders and independent businesses.",
  ...
  selectedWork: {
    ...
    description: "A focused selection across booking, lead generation, subscription content, logistics, and SaaS — paired with brand-forward execution.",
    ...
    projects: [
      {
        ...
        summary: "Booking platform with Shopify integration and real-time scheduling for a Manhattan salon.",
        role: "Full-stack build",
        outcome: "Premium booking flow",
        client: "Independent Manhattan salon — luxury hair brand.",
        timeline: "8 weeks · solo build",
        problem: "The salon was juggling DMs, calls, and a spreadsheet to manage bookings. Their Shopify storefront and scheduling were disconnected, so loyal clients had a clumsy path to rebook.",
        approach: [
      ...
      },
      {
        ...
        summary: "Lead-generation application for an employment and lending firm with clean intake and routing.",
        role: "Full-stack build",
        outcome: "Cleaner lead pipeline",
        client: "US lending and employment firm with multiple offices.",
        timeline: "6 weeks · solo build",
        problem: "Leads arrived via PDFs, calls, and email. Routing was manual, follow-ups slipped, and the team had no visibility into pipeline health.",
        approach: [
      ...
      },
      {
        ...
        summary: "Subscription platform with BunnyStream video delivery, Stripe billing, and admin tooling.",
        role: "Platform build",
        ...
        problem: "The founder wanted a recurring revenue product without giving up brand control to a generic course platform.",
        approach: [
      ...
      },
      {
        ...
        summary: "Brand-forward logistics site focused on trust, services, and client acquisition.",
        role: "Frontend build",
        outcome: "Sharper sales presence",
        client: "B2B logistics operator across LATAM corridors.",
        timeline: "4 weeks · frontend engagement",
        problem: "The existing site read as a brochure and didn't communicate the operational depth the sales team relied on.",
        approach: [
      ...
      },
      {
        ...
        summary: "Editorial site focused on brand presence, menu clarity, and customer action.",
        role: "Frontend build",
        ...
        problem: "Customers had to dig through social posts for menu, hours, and location. The brand deserved a real home.",
        approach: [
      ...
      },
      {
        ...
        summary: "Admin dashboards, billing flows, and integration glue for early-stage SaaS teams.",
        role: "Full-stack build",
        ...
        problem: "Founders had product-market fit signals but no time to harden billing, admin tooling, and internal ops.",
        approach: [
  ...
  process: {
    ...
    description: "I keep the engagement disciplined: define the valuable version, build the system in vertical slices, and leave behind code that can be operated.",
    steps: [
  ...
  stack: {
    ...
    description: "I choose boring foundations where reliability matters and reserve craft for the places customers actually feel.",
    groups: [
  ...
  contact: {
    ...
    description: "I take on a small number of focused builds. Send the problem, the timeline, and the outcome you need.",
    fields: {
      name: "Name",
      namePh: "Your name",
      email: "Email",
...
const es = {
  ...
  hero: {
    ...
    description: "Diseño y entrego frontends pulidos, APIs en Node.js y sistemas en producción para fundadores SaaS y negocios en crecimiento que necesitan un ingeniero senior de principio a fin.",
    ...
    currentSignalBody: "Experiencia consultiva en empresa con Airbus y Bosch, junto con producto de principio a fin para fundadores SaaS y negocios independientes.",
  ...
  selectedWork: {
    ...
    description: "Una selección enfocada en reservas, generación de leads, contenido por suscripción, logística y SaaS — con ejecución orientada a marca.",
    ...
    projects: [
      {
        ...
        summary: "Plataforma de reservas con integración a Shopify y agenda en tiempo real para un salón de Manhattan.",
        ...
        problem: "El salón gestionaba reservas entre DMs, llamadas y una hoja de cálculo. Su tienda en Shopify y la agenda estaban desconectadas, por lo que reservar era torpe para clientes leales.",
        approach: [
      ...
      },
      {
        ...
        title: "Lending Group, Texas",
        summary: "Aplicación de generación de leads para una firma de empleo y préstamos con captura y enrutamiento limpios.",
        role: "Desarrollo full-stack",
        ...
        problem: "Los leads llegaban por PDFs, llamadas y correo. El enrutamiento era manual, los seguimientos se perdían y el equipo no tenía visibilidad del pipeline.",
        approach: [
      ...
      },
      {
        ...
        summary: "Plataforma por suscripción con video vía BunnyStream, cobros en Stripe y herramientas de administración.",
        ...
        problem: "La fundadora quería un producto de ingreso recurrente sin ceder control de marca a una plataforma de cursos genérica.",
        approach: [
      ...
      },
      {
        ...
        summary: "Sitio de logística orientado a marca, enfocado en confianza, servicios y captación de clientes.",
        ...
        problem: "El sitio existente parecía un folleto y no comunicaba la profundidad operativa en la que confiaba el equipo comercial.",
        approach: [
      ...
      },
      {
        ...
        summary: "Sitio editorial enfocado en presencia de marca, claridad de menú y acción del cliente.",
        role: "Desarrollo frontend",
        ...
        problem: "Los clientes tenían que buscar entre publicaciones sociales el menú, horarios y ubicación. La marca merecía un hogar real.",
        approach: [
      ...
      },
      {
        ...
        summary: "Dashboards de administración, flujos de cobro e integraciones para equipos SaaS en etapa temprana.",
        role: "Desarrollo full-stack",
        ...
        problem: "Los fundadores tenían señales de product-market fit pero no tiempo para endurecer cobro, administración y operaciones internas.",
        approach: [
  ...
  process: {
    ...
    description: "Mantengo el proyecto disciplinado: definir la versión valiosa, construir el sistema en cortes verticales y dejar código que se pueda operar.",
    steps: [
  ...
  stack: {
    ...
    description: "Elijo fundamentos aburridos donde la fiabilidad importa, y reservo el oficio para los lugares que el cliente sí siente.",
    groups: [
      { title: "Frontend", items: ["Angular", "React", "Vue", "TypeScript", "Tailwind", "RxJS"] },
  ...
  contact: {
    ...
    description: "Tomo un número pequeño de proyectos enfocados. Envía el problema, los tiempos y el resultado que necesitas.",
    fields: {
      name: "Nombre",
      namePh: "Tu nombre",
      email: "Correo",
...
function LanguageProvider({ children }) {
  ...
  const setLang = reactExports.useCallback(
    (l) => {
...
const Route$2 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Senior full-stack engineer shipping polished frontends, Node.js APIs, and production systems for SaaS founders and growing businesses."
      },
      { name: "author", content: "Pablo Salcido" },
      { property: "og:title", content: "Pablo Salcido — Senior Full-Stack Engineer" },
      {
        property: "og:description",
        content: "Polished frontends, Node.js APIs, and production systems for SaaS founders and growing businesses."
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,500;12..96,600;12..96,700;12..96,800&family=Hanken+Grotesk:wght@400;500;600&family=Geist+Mono:wght@400;500&display=swap"
      }
    ]
  }),
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LanguageProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TransitionWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) }) });
}
const $$splitComponentImporter = () => import("./index-BRsq5BDJ.mjs");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Pablo Salcido — senior full-stack engineer building polished SaaS products and production systems for founders and small-to-medium businesses."
    }, {
      property: "og:title",
